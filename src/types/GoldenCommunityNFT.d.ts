...
interface GoldenCommunityNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class GoldenCommunityNFT extends Contract {
  ...
  interface: GoldenCommunityNFTInterface;
