...
interface BronzeCommunityNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class BronzeCommunityNFT extends Contract {
  ...
  interface: BronzeCommunityNFTInterface;
