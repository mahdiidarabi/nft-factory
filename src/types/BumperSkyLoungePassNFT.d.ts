...
interface BumperSkyLoungePassNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class BumperSkyLoungePassNFT extends Contract {
  ...
  interface: BumperSkyLoungePassNFTInterface;
