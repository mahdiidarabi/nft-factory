...
interface DiamondCommunityNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class DiamondCommunityNFT extends Contract {
  ...
  interface: DiamondCommunityNFTInterface;
