...
interface SilverCommunityNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class SilverCommunityNFT extends Contract {
  ...
  interface: SilverCommunityNFTInterface;
